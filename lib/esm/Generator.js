import { __assign, __awaiter, __generator, __makeTemplateObject, __spreadArrays } from "tslib";
...
import { castArray, dedent, groupBy, isArray, isEmpty, isFunction, memoize, noop, omit, uniq, values, } from 'vtils';
...
var Generator = /** @class */ (function () {
    function Generator(config, options) {
        ...
        this.config =
            ...
            castArray(config).map(function (item) {
                if (item.serverUrl) {
                    // 去除地址后面的 /
                                                                                    ...
                                                                                    return __generator(this, function (_c) {
                                                                                        switch (_c.label) {
                                                                                            ...
                                                                                            case 1:
                                                                                                ...
                                                                                                outputFilePath = path.resolve(this.options.cwd, syntheticalConfig.outputFilePath);
                                                                                            ...
                                                                                            case 3:
                                                                                                _a = __spreadArrays.apply(void 0, _b.concat([(_c.sent())])).join('\n\n');
                                                                                                _c.label = 4;
                                                                                            case 4:
                                                                                                categoryCode = _a;
                                                                                                    ...
                                                                                                    outputFileList[outputFilePath] = {
                                                                                                        ...
                                                                                                        requestHookMakerFilePath: syntheticalConfig.reactHooks &&
                                                                                                            ...
                                                                                                            ? syntheticalConfig.reactHooks
                                                                                                                ...
                                                                                                                ? path.resolve(this.options.cwd, syntheticalConfig.reactHooks
                                                                                                                    .requestHookMakerFilePath)
                        ...
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                ...
                                case 6:
                                    ...
                                    _c.label = 7;
                                case 7:
                                    rawOutputContent = dedent(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n          /* tslint:disable */\n          /* eslint-disable */\n\n          /* \u8BE5\u6587\u4EF6\u7531 yapi-to-typescript \u81EA\u52A8\u751F\u6210\uFF0C\u8BF7\u52FF\u76F4\u63A5\u4FEE\u6539\uFF01\uFF01\uFF01 */\n\n          ", "\n        "], ["\n          /* tslint:disable */\n          /* eslint-disable */\n\n          /* \u8BE5\u6587\u4EF6\u7531 yapi-to-typescript \u81EA\u52A8\u751F\u6210\uFF0C\u8BF7\u52FF\u76F4\u63A5\u4FEE\u6539\uFF01\uFF01\uFF01 */\n\n          ",
                                        "\n        "
                                    ...
                                    prettyOutputContent = prettier.format(rawOutputContent, {
                                        parser: 'typescript',
                                        printWidth: 120,
                                        tabWidth: 2,
                                        singleQuote: true,
                                    ...
                                    outputContent = dedent(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n          /* prettier-ignore-start */\n          ", "\n          /* prettier-ignore-end */\n        "], ["\n          /* prettier-ignore-start */\n          ", "\n          /* prettier-ignore-end */\n        "])), prettyOutputContent) + "\n";
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve) {
                        exec(require.resolve('typescript/bin/tsc') + " --target ES2019 --module ESNext --jsx preserve --declaration --esModuleInterop " + file, {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (interfaceInfo.method) {
                    ...
                    case Method.HEAD:
                    case Method.OPTIONS:
                        jsonSchema = propDefinitionsToJsonSchema(interfaceInfo.req_query.map(function (item) { return ({
                            name: item.name,
                ...
                if (isArray(interfaceInfo.req_params) && interfaceInfo.req_params.length) {
                    paramsJsonSchema = propDefinitionsToJsonSchema(interfaceInfo.req_params.map(function (item) { return ({
                        name: item.name,
                        required: true,
                        type: 'string',
                        comment: item.desc,
                    ...
                    if (jsonSchema) {
                        ...
                        jsonSchema.required = __spreadArrays((jsonSchema.required || []), (paramsJsonSchema.required || []));
                    }
                    else {
                        jsonSchema = paramsJsonSchema;
                    }
                }
                return [2 /*return*/, jsonSchemaToType(jsonSchema, typeName)];
            });
        });
    };
    /** 生成响应数据类型 */
    ...
    Generator.prototype.fetchApi = function (url, query) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, got.get(url, {
                            searchParams: query,
                            responseType: 'json',
                        })
                        /* istanbul ignore next */
                ...
                switch (_f.label) {
                    ...
                    case 16:
                        ...
                        interfaceExtraComments = interfaceSummary
                            .filter(function (item) { return !isEmpty(item.value); })
                            .map(function (item) { return "* @" + item.label + " " + castArray(item.value).join(', '); })
                            .join('\n');
                        return [2 /*return*/, dedent(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n      /**\n       * \u63A5\u53E3 ", " \u7684 **\u8BF7\u6C42\u7C7B\u578B**\n       *\n       ", "\n       */\n      ", "\n\n      /**\n       * \u63A5\u53E3 ", " \u7684 **\u8FD4\u56DE\u7C7B\u578B**\n       *\n       ", "\n       */\n      ", "\n\n      ", "\n    "], ["\n      /**\n       * \u63A5\u53E3 ", " \u7684 **\u8BF7\u6C42\u7C7B\u578B**\n       *\n       ", "\n       */\n      ", "\n\n      /**\n       * \u63A5\u53E3 ", " \u7684 **\u8FD4\u56DE\u7C7B\u578B**\n       *\n       ", "\n       */\n      ", "\n\n      ",
                                ...
                                : dedent(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n            /**\n             * \u63A5\u53E3 ", " \u7684 **\u8BF7\u6C42\u914D\u7F6E\u7684\u7C7B\u578B**\n             *\n             ", "\n             */\n            type ", " = Readonly<RequestConfig<\n              ", ",\n              ", ",\n              ", ",\n              ", ",\n              ", ",\n              ", ",\n              ", ",\n              ", "\n            >>\n\n            /**\n             * \u63A5\u53E3 ", " \u7684 **\u8BF7\u6C42\u914D\u7F6E**\n             *\n             ", "\n             */\n            const ", ": ", " = {\n              mockUrl: mockUrl", ",\n              devUrl: devUrl", ",\n              prodUrl: prodUrl", ",\n              path: ", ",\n              method: Method.", ",\n              requestBodyType: RequestBodyType.", ",\n              responseBodyType: ResponseBodyType.", ",\n              dataKey: dataKey", ",\n              paramNames: ", ",\n              queryNames: ", ",\n              requestDataOptional: ", ",\n            }\n\n            /**\n             * \u63A5\u53E3 ", " \u7684 **\u8BF7\u6C42\u51FD\u6570**\n             *\n             ", "\n             */\n            export const ", " = makeRequest<", ", ", ", ", ">(", ")\n\n            ", "\n          "], ["\n            /**\n             * \u63A5\u53E3 ", " \u7684 **\u8BF7\u6C42\u914D\u7F6E\u7684\u7C7B\u578B**\n             *\n             ", "\n             */\n            type ", " = Readonly<RequestConfig<\n              ", ",\n              ", ",\n              ", ",\n              ", ",\n              ", ",\n              ", ",\n              ", ",\n              ", "\n            >>\n\n            /**\n             * \u63A5\u53E3 ", " \u7684 **\u8BF7\u6C42\u914D\u7F6E**\n             *\n             ", "\n             */\n            const ", ": ", " = {\n              mockUrl: mockUrl", ",\n              devUrl: devUrl", ",\n              prodUrl: prodUrl", ",\n              path: ", ",\n              method: Method.", ",\n              requestBodyType: RequestBodyType.",
                                    ...
                                    : interfaceInfo.req_body_type /* istanbul ignore next */ ||
                                        RequestBodyType.none, interfaceInfo.res_body_type, categoryUID, paramNamesLiteral, queryNamesLiteral, JSON.stringify(isRequestDataOptional), interfaceTitle, interfaceExtraComments, requestFunctionName, requestDataTypeName, responseDataTypeName, requestConfigTypeName, requestConfigName, !syntheticalConfig.reactHooks ||
                                    !syntheticalConfig.reactHooks.enabled
                                    ? ''
                                    : dedent(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n                  /**\n                   * \u63A5\u53E3 ", " \u7684 **React Hook**\n                   *\n                   ", "\n                   */\n                  export const ", " = makeRequestHook<", ", ", ", ReturnType<typeof ", ">>(", ")\n                "], ["\n                  /**\n                   * \u63A5\u53E3 ", " \u7684 **React Hook**\n                   *\n                   ", "\n                   */\n                  export const ", " = makeRequestHook<", ", ", ", ReturnType<typeof ", ">>(", ")\n                "])), interfaceTitle, interfaceExtraComments, requestHookName, requestDataTypeName, requestConfigTypeName, requestFunctionName, requestFunctionName)))];
                }
            });
        });
    };
