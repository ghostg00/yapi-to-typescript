 ...
 * 请求配置。
 */
export interface RequestConfig<MockUrl extends string = any, DevUrl extends string = any, ProdUrl extends string = any, Path extends string = any, DataKey extends string | undefined = any, ParamName extends string = any, QueryName extends string = any, RequestDataOptional extends boolean = any> {
    /** 接口 Mock 地址，结尾无 `/` */
    mockUrl: MockUrl;
    /** 接口测试环境地质，结尾无 `/` */
    devUrl: DevUrl;
